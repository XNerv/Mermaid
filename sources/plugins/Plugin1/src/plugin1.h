...
class Plugin1 : public Mermaid::Engine::Managers::Plugin::IPlugin
{
public:
	Plugin1(Mermaid::Engine::Application::IApplicationContext * const applicationContext): IPlugin(applicationContext)
	{
		/*IPlugin::getApplicationContext()->getAppMenuRepository().getMenu(4)->getPopupMenu()->addItem(624877, "Plugin 1");
		IPlugin::getApplicationContext()->getAppMenuRepository().getMenu(1)->getPopupMenu()->addItem(624871, "Plugin 1");*/
	};
