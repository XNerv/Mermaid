...
class Plugin2 : public Mermaid::Engine::Managers::Plugin::IPlugin
{
public:
	Plugin2(Mermaid::Engine::Application::IApplicationContext* applicationContext): IPlugin(applicationContext)
	{
		/*IPlugin::getApplicationContext()->getAppMenuRepository().getMenu(4)->getPopupMenu()->addItem(569877, "Plugin 2");*/
	};
