...
public:
	...
	*/
	void layoutColumns(const juce::Rectangle<int> & area)
	{
...
private:
	juce::Rectangle<float> topArea, midArea, bottomArea, centreArea;
...
juce::Rectangle<int> JAdvancedDock::getWindowBoundsAtPoint(const Point<int>& p)
{
...
void JAdvancedDock::layoutRows(const juce::Rectangle<int>& area)
{
	std::vector<Component *> comps;
